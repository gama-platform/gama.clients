...
class TestSyncClientCore(unittest.IsolatedAsyncioTestCase):
    """
    ...
    async def test_client_initialization_with_default_timeout(self):
        """
        Test that the client initializes correctly with a default timeout.
        """
        assert self.client.default_timeout == default_timeout

    async def test_load_with_default_timeout_nothing_happens(self):
        """
    ...
    async def test_load_with_timeout_nothing_happens(self):
        """
    ...
    async def test_load_with_timeout_reached(self):
        """
    ...
    async def test_load_with_default_timeout_reached(self):
        """
    ...
    async def test_no_timeout_behavior(self):
        """
    ...
    async def test_default_timeout_usage(self):
        """
        Test that default timeout is used when no timeout is specified.
        """
        # Create client with short default timeout
        short_timeout_client = GamaSyncClient(url, port, default_timeout=5.0)
    ...
    async def asyncTearDown(self):
        """
        Clean up all experiments and close connection.
        """
